...
namespace ResponsesATSPersonal
{
    ...
    public class SMAResponsePub : ResponseTemplateBasePub
    {
        ...
        public SMAResponsePub() : this(true) { }
        public SMAResponsePub(bool prompt)
        {
            _black = !prompt;
    ...
    /// </summary>
    public class SMAResponseAutoPub : SMAResponsePub
    {
        public SMAResponseAutoPub() : base(false) { }
    }
}
