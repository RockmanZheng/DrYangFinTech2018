...
{
    public class DSMAWithStopLossIntraday2 : ResponseBase
    {
        public DSMAWithStopLossIntraday2(bool prompt) : base(prompt) { }
        public DSMAWithStopLossIntraday2() : this(true) { }
        ...
        public override void DoStrategy()
        {
            ...
            if (!isWait)
            {
                ...
                else if (position == 0)// Flat position
                {
    ...
    public class DSMAWithStopLossIntraday2Auto : DSMAWithStopLossIntraday2
    {
        public DSMAWithStopLossIntraday2Auto() : base(false) { }
    }
}
