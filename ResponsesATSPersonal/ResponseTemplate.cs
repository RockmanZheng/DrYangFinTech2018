...
{
    public class ResponseTemplate : ResponseTemplateBasePub
    {
        ...
        string[] _indicators = new string[] { "Time", "idx"};

        #region ImplementationNeeded
        /// <summary>
        ...
        public ResponseTemplate(bool prompt)
        {
        ...
        /// </summary>
        public ResponseTemplate() : this(true) { }
    ...
    /// </summary>
    public class ResponseTemplateAuto : ResponseTemplate
    {
        public ResponseTemplateAuto() : base(false) { }
    }
}
